  ...
  switch (variant) {
    ...
    case 'news_channel':
      return {
        ...
        labelStyle: {
          ...sharedLabel,
          background: `linear-gradient(135deg, ${themeColor}, rgba(${rgb}, 0.72))`,
          color: '#fff',
        ...
        accentStyle: {
          ...
          inset: 0,
          pointerEvents: 'none',
          background: 'linear-gradient(90deg, rgba(15,23,42,0.04), transparent 12%, transparent 88%, rgba(15,23,42,0.04))',
        },
        topLineStyle: {
          position: 'absolute',
          top: 0,
          ...
          right: 0,
          height: '2px',
          background: `linear-gradient(90deg, ${themeColor}, rgba(255,255,255,0.95), ${themeColor})`,
        },
        labelDotStyle: {
          width: isMobile ? '7px' : '9px',
          height: isMobile ? '7px' : '9px',
